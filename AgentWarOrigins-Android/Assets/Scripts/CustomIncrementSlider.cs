...
{
    [AddComponentMenu("UI/CustomIncrementSlider")]
    [RequireComponent(typeof(RectTransform))]
    public class CustomIncrementSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        [SerializeField]
        private bool m_CustomIncrement = false;
        public bool CustomIncrement { get { return m_CustomIncrement; } set { if (SetPropertyUtility.SetStruct(ref m_CustomIncrement, value)) { Set(m_Value); UpdateVisuals(); } } }
        public int incrementSize = 10; 
        [SerializeField]
        ...
        // Size of each step.
        float stepSize { get { return CustomIncrement ? incrementSize : (maxValue - minValue) * 0.1f; } }

        protected CustomIncrementSlider()
        { }
