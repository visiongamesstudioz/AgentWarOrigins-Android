...
public class TimeMachineClipInspector : Editor
{
    ...
    private SerializedProperty activateArrow, player, swipeType;
	...
	public override void OnInspectorGUI()
	{
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("ActivateArrow"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("player"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("swipeType"));

        //  activateArrow = (GameObject)EditorGUILayout.ObjectField(activateArrow, typeof(GameObject), true);
        ...
        if (!isMarker)
		{
			...
			switch(conditionType)
			{
				...
				case TimeMachineBehaviour.Condition.AgentIsAlive:
